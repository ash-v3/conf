...
set -U fish_color_command $c_1 --bold # commands like echo
set -U fish_color_keyword $c_1 --bold # keywords like if - this falls back on the command color if unset
set -U fish_color_quote $c_3 # quoted text like "abc"
set -U fish_color_redirection $c_3 --bold --italics # IO redirections like >/dev/null
...
set -U fish_color_valid_path $c_3 --bold --italics # parameters that are filenames (if the file exists)
set -U fish_color_option $c_3 --bold --italics # options starting with “-”, up to the first “--” parameter
...
set -U fish_color_cwd $c_2 --bold # the current working directory in the default prompt
set -U fish_color_cwd_root $c_2 --bold # the current working directory in the default prompt for the root user
...
set -U color_suffix $c_1 --bold # suffix color
