...
set -U fish_color_end $c_3 --bold # process separators like ; and &
...
set -U fish_color_option $c_2 --bold # options starting with “-”, up to the first “--” parameter
...
set -U color_vcs_prompt $c_2 --bold --underline # git color
set -U color_suffix $c_3 --bold --underline # suffix color
