...
_G.packer_plugins = {
  ...
  ["auto-save.nvim"] = {
    ...
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/auto-save.nvim",
  ...
  ["chatgpt.nvim"] = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/chatgpt.nvim",
  ...
  ["navigator.lua"] = {
    ...
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/navigator.lua",
  ...
  ["nvim-code-action-menu"] = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/nvim-code-action-menu",
  ...
  ["shenzhen-solitaire.nvim"] = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/shenzhen-solitaire.nvim",
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'delimitMate', 'better-escape.vim', 'ultisnips'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-sandwich', 'vim-indent-object', 'vim-commentary', 'unicode.vim', 'targets.vim', 'open-browser.vim', 'hop.nvim', 'whitespace.nvim', 'vim-matchup', 'neoscroll.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
