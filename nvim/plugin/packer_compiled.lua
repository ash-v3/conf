...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdownfootnotes', 'vim-markdown', 'markdown-preview.nvim', 'vim-grammarous'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'whitespace.nvim', 'neoscroll.nvim', 'vim-sandwich', 'vim-matchup', 'hop.nvim', 'vim-indent-object', 'vim-commentary', 'unicode.vim', 'targets.vim', 'open-browser.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
