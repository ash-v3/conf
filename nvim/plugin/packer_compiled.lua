...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-grammarous', 'vim-markdownfootnotes', 'vim-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'neoscroll.nvim', 'hop.nvim', 'vim-commentary', 'targets.vim', 'open-browser.vim', 'whitespace.nvim', 'unicode.vim', 'vim-sandwich', 'vim-matchup', 'vim-indent-object'}, { event = "VimEnter *" }, _G.packer_plugins)]]
