...
_G.packer_plugins = {
  ...
  ["nnn.nvim"] = {
    ...
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/nnn.nvim",
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'targets.vim', 'whitespace.nvim', 'open-browser.vim', 'vim-matchup', 'hop.nvim', 'vim-indent-object', 'vim-commentary', 'unicode.vim', 'vim-sandwich', 'neoscroll.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
