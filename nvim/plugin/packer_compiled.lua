...
_G.packer_plugins = {
  ...
  ["neoterm.nvim"] = {
    config = { "\27LJ\2\nb\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\3\rnoinsert\1\17clear_on_run\2\tmode\rvertical\nsetup\fneoterm\frequire\0" },
    loaded = true,
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-markdown', 'vim-grammarous', 'vim-markdownfootnotes'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'hop.nvim', 'whitespace.nvim', 'neoscroll.nvim', 'vim-sandwich', 'vim-matchup', 'vim-indent-object', 'unicode.vim', 'targets.vim', 'vim-commentary', 'open-browser.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
