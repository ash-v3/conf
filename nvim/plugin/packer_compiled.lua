...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-grammarous', 'markdown-preview.nvim', 'vim-markdown', 'vim-markdownfootnotes'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-indent-object', 'neoscroll.nvim', 'vim-commentary', 'unicode.vim', 'hop.nvim', 'open-browser.vim', 'targets.vim', 'whitespace.nvim', 'vim-sandwich', 'vim-matchup'}, { event = "VimEnter *" }, _G.packer_plugins)]]
