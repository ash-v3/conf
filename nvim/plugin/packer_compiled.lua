...
_G.packer_plugins = {
  ...
  ["coq.artifacts"] = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/coq.artifacts",
    url = "https://github.com/ms-jpq/coq.artifacts"
  },
  ["coq.thirdparty"] = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/coq.thirdparty",
    url = "https://github.com/ms-jpq/coq.thirdparty"
  },
  coq_nvim = {
    config = { "\27LJ\2\n-\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\18user.coq_nvim\frequire\0" },
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/coq_nvim",
  ...
  ["neoterm.nvim"] = {
    config = { "\27LJ\2\nb\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\3\rnoinsert\1\tmode\rvertical\17clear_on_run\2\nsetup\fneoterm\frequire\0" },
    loaded = true,
  ...
  ["tex-conceal.vim"] = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/tex-conceal.vim",
  ...
  ["vim-snippets"] = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/vim-snippets",
...
try_loadstring("\27LJ\2\n-\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\18user.coq_nvim\frequire\0", "config", "coq_nvim")
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdownfootnotes', 'vim-markdown', 'vim-grammarous', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'better-escape.vim', 'delimitMate'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'neoscroll.nvim', 'vim-sandwich', 'whitespace.nvim', 'vim-matchup', 'vim-indent-object', 'vim-commentary', 'unicode.vim', 'targets.vim', 'open-browser.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
