...
_G.packer_plugins = {
  ...
  chadtree = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/chadtree",
  ...
  ["hop.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/ash/.local/share/nvim/site/pack/packer/opt/hop.nvim",
  ...
  ["nvim-ts-autotag"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/ash/.local/share/nvim/site/pack/packer/opt/nvim-ts-autotag",
  ...
  ["vim-closer"] = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/vim-closer",
  ...
  ["vim-endwise"] = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/vim-endwise",
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown', 'vim-grammarous', 'markdown-preview.nvim', 'vim-markdownfootnotes'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'delimitMate', 'nvim-ts-autotag', 'better-escape.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'whitespace.nvim', 'neoscroll.nvim', 'vim-matchup', 'vim-indent-object', 'vim-commentary', 'hop.nvim', 'targets.vim', 'unicode.vim', 'open-browser.vim', 'vim-sandwich'}, { event = "VimEnter *" }, _G.packer_plugins)]]
