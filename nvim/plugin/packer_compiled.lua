...
_G.packer_plugins = {
  ...
  coq_nvim = {
    config = { "\27LJ\2\n(\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\ruser.coq\frequire\0" },
    loaded = true,
  ...
  ["neoterm.nvim"] = {
    config = { "\27LJ\2\nb\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\3\17clear_on_run\2\tmode\rvertical\rnoinsert\1\nsetup\fneoterm\frequire\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\n(\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\ruser.coq\frequire\0", "config", "coq_nvim")
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'delimitMate', 'better-escape.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'whitespace.nvim', 'vim-sandwich', 'vim-indent-object', 'vim-commentary', 'unicode.vim', 'targets.vim', 'open-browser.vim', 'vim-matchup', 'neoscroll.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
